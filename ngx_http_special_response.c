...
static char ngx_http_error_300_page[] =
"<html>" CRLF
"<head><title>HTTP Error</title></head>" CRLF
"<body>" CRLF
"<p>HTTP Error</p>" CRLF
;
...
"<html>" CRLF
"<head><title>Request Error</title></head>" CRLF
"<body>" CRLF
"<p>Request Error</p>" CRLF
;
...
"<body>" CRLF
"<p>Internal Server Error</p>" CRLF
;
...
#define NGX_HTTP_OFF_3XX   (NGX_HTTP_LAST_2XX - 201)
    ...
    /* ngx_null_string, */               /* 300 */
    ngx_string(ngx_http_error_300_page),
    ngx_string(ngx_http_error_300_page),
    ngx_string(ngx_http_error_300_page),
    ngx_null_string,                     /* 304 */
    ngx_null_string,                     /* 305 */
...
#define NGX_HTTP_OFF_5XX   (NGX_HTTP_LAST_4XX - 400 + NGX_HTTP_OFF_4XX)
    ...
    ngx_string(ngx_http_error_400_page), /* 494, request header too large */
    ngx_string(ngx_http_error_400_page), /* 495, https certificate error */
    ngx_string(ngx_http_error_400_page), /* 496, https no certificate */
    ngx_string(ngx_http_error_400_page), /* 497, http to https */
    ngx_string(ngx_http_error_400_page), /* 498, canceled */
